  ...
  const fetchData = async () => {
    try {
      ...
      if (found) {
        ...
        setEditForm({ name: found.name, code: found.code, place: found.place || '', logo_url: found.logo_url || '', banner_url: found.banner_url || '', theme_color_1: found.theme_color_1 || '#4f46e5', theme_color_2: found.theme_color_2 || '#312e81' });
      }
    } catch (err) {
      console.error(err);
    } finally {
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <button 
            onClick={() => {
              if (isEditing) { setIsEditing(false); setEditLogoFile(null); setEditBannerFile(null); setEditForm({ name: institution.name, code: institution.code, place: institution.place || '', logo_url: institution.logo_url || '', banner_url: institution.banner_url || '', theme_color_1: institution.theme_color_1 || '#4f46e5', theme_color_2: institution.theme_color_2 || '#312e81' }); }
